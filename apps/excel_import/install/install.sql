...
CREATE TABLE `qnn_cost_electric_list`  (
  ...
  `park` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT ''所在园区'',
  `build_id` int(11) NULL DEFAULT NULL COMMENT ''楼宇号'',
  ...
  `meter_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ''电表号'',
  ...
  `used_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT ''用电金额'',
...
CREATE TABLE `qnn_cost_water_list`  (
  ...
  `year` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT ''年份'',
  `month` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT ''月份'',
  `park` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT ''所属园区'',
  `build_id` int(11) NULL DEFAULT NULL COMMENT ''楼宇号'',
  `floor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ''楼层'',
  `room_number` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ''房间号'',
  `area` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ''房间面积'',
