...
CREATE TABLE IF NOT EXISTS `eacoo_posts` (
  ...
  `source` varchar(100) DEFAULT '' COMMENT '来源标记',
  ...
  `comment_count` int(11) unsigned DEFAULT '0' COMMENT '冗余评论数',
  `parent` int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'post的父级post id,表示post层级关系',
  `password` varchar(32) NOT NULL DEFAULT '' COMMENT '密码',
  `fields` varchar(300) NOT NULL DEFAULT '' COMMENT 'post的扩展字段，保存相关扩展属性，如缩略图；格式为json',
  ...
  `publish_time` datetime NOT NULL DEFAULT '0001-01-01 00:00:00' COMMENT '发布时间',
...
VALUES
  ...
  (3, '机器学习专家带你实践LSTM语言模型', '', 'post', NULL, '', '<p>测试</p><p><br></p>', 1, 0, '', 94, 100, 13, 0, 0, '', '', 0, 0, '2018-09-30 22:32:26', '2018-09-30 22:32:26', '2018-09-30 22:32:26', 99, 1),
  (4, '大撒发送大撒发送', '', 'page', NULL, '', '<p style=\"text-align:center\"><br/></p><p>这是编辑的内容就gsadfasdfasfd</p><p></p>', 1, 1, '', 1164, 100, 0, 0, 0, '', '', 0, 0, '2018-09-30 22:32:26', '2018-09-30 22:32:26', '2018-09-30 22:32:26', 99, -1),
  (5, '贝恩：企业大数据战略指南', '', 'post', NULL, '这是摘要dgs', '<p>企业大数据战略指南</p><p><br></p><p><img class=\"\" src=\"http://localhost/ZhaoCMF/Uploads/Picture/2016-09-26/57e8ddc3e1455.jpeg\" data-id=\"363\"></p><p>fsafsaf</p><p><br></p>', 1, 1, '关键字1', 88, 100, 0, 0, 0, '', '', 1, 0, '2018-09-30 22:32:26', '2018-09-30 22:32:26', '2018-09-30 22:32:26', 99, 1),
  (6, '发撒范德萨', '', 'post', NULL, '', '<p>撒发达范德萨发送</p>', 1, 0, '', 27, 100, 0, 0, 0, '', '', 0, 0, '2018-09-30 22:32:26', '2018-09-30 22:32:26', '2018-09-30 22:32:26', 99, 1),
  (7, '关于我们', '', 'page', NULL, NULL, '<p>EacooPHP是基于ThinkPHP5开发的一套轻量级WEB产品开发框架，追求高效，简单，灵活。具有完善并灵活的模块化和插件机制，模块式开发，大大降低开发成本。</p>', 1, 1, 'EacooPHP是基于ThinkPHP5开发的一套轻量级WEB产品开发框架', NULL, 100, 0, 0, 0, '', '', 0, 0, '2018-09-30 22:32:26', '2018-09-30 22:32:26', '2018-09-30 22:32:26', 99, 1);
